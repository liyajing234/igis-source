...
P.PlotUtils = {}, P.PlotUtils.distance = function (t, o) {
    ...
    for (let o = 0, e = 0; e < t.length - 1; e++) o += P.PlotUtils.distance(t[e], t[e + 1]);
    return o
    ...
    let e, r = Math.asin(Math.abs(o[1] - t[1]) / P.PlotUtils.distance(t, o));
    ...
    for (let e = P.PlotUtils.getLeftMostControlPoint(o), r = [e], n = 0; n < o.length - 2; n++) {
        let g = o[n],
            i = o[n + 1],
            s = o[n + 2],
    ...
    for (n = 0; n < o.length - 1; n++) {
        ...
        for (let t = 0; t < P.Constants.FITTING_COUNT; t++) {
            let c = P.PlotUtils.getCubicValue(t / P.Constants.FITTING_COUNT, g, r[2 * n], r[2 * n + 1], i);
            u.push(c)
        }
        u.push(i)
    }
    ...
    if (a > P.Constants.ZERO_TOLERANCE) let l = P.PlotUtils.mid(e, r),
        u = e[0] - l[0],
        c = e[1] - l[1],
    ...
    if (l > P.Constants.ZERO_TOLERANCE) let u = P.PlotUtils.mid(n, g),
        c = g[0] - u[0],
        p = g[1] - u[1],
    ...
    for (let o = [], e = t.length - 1, r = 0; 1 >= r; r += .01) {
        for (let n = y = 0, g = 0; e >= g; g++) {
